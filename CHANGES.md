...
RESULT: works
BLOCKERS: "serban theories" not found in any stored data — no URL to restore; user should re-add if they have the URL
...
## 2026-06-03 src/lib/ProjectsTab.svelte — DONE
TASK: Project REFERENCES tab: same list style as song refs with download button
...
## 2026-06-03 momentum-watcher.cjs + analyze_vocal_eq.py — DONE
TASK: Switch Demucs model from htdemucs_ft to htdemucs for faster analysis
