...
<style>
  ...
  .subs-total{font-size:10px;color:#9e9690;margin-left:8px;text-transform:none;letter-spacing:0;font-family:'DM Sans',sans-serif}
  .subs-arrow{font-size:10px;color:#6b6762;transition:transform .2s;display:inline-block}
  ...
  .billing-day{font-family:'Space Mono',monospace;font-size:9px;color:#555}
  .sub-amt{font-family:'Space Mono',monospace;font-size:11px;color:#cec9c1}
  .sub-renewal{font-family:'Space Mono',monospace;font-size:7px;color:#6b6762;text-transform:uppercase}
  .sub-arr{font-size:9px;color:#6b6762;transition:transform .2s}
  ...
  .field-lbl{font-family:'Space Mono',monospace;font-size:9px;letter-spacing:.1em;text-transform:uppercase;color:rgba(201,168,76,.85)}
